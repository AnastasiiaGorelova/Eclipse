...
void game_window::on_start_clicked() { damn->start_game(); }

void game_window::on_exit_clicked() { damn->cancel_game(); }

void game_window::set_god(God *damn_) { damn = damn_; }

void game_window::on_local_board_clicked() {
  damn->show_leaderboard(local_leaderboard);
}

void game_window::on_history_clicked() { damn->show_legend_window(); }
