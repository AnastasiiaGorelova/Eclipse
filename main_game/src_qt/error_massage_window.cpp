...
error_massage_window::~error_massage_window() { delete ui; }
...
void error_massage_window::arduino_setting_error() {
  ...
  connect(back_to_selection_window, &QPushButton::released, this,
          &error_massage_window::_on_back_to_menu_clicked);
...
void error_massage_window::set_god(God *damn_) { damn = damn_; }
