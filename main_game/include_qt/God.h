...
=======
    ...
    static void make_move_in_logic();  //раз в какое-то время меняем картинку,
                                       //если ничего не нажали

    // both
    static void make_changes_in_qt();  //боженька приниает изменения из логики,
